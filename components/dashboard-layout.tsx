...
import { Home, FileText, User, Settings, LogOut, Moon, Sun, Menu, History, Shield, LayoutDashboard, FileQuestion, Users, Flag, Stethoscope, Ticket, Bug, CreditCard, Bell, Star, BookOpen } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Gerar Simulados', href: '/generator', icon: FileText },
  { name: 'Questões Livres', href: '/free-questions', icon: BookOpen },
